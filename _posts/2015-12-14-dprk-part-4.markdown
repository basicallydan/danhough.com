...
It was a pretty good kimbap, too.
...
{% include _figure.html src="/img/dprk-part-4/airport-departures.jpg" caption="Not a bad place to be laid to rest. It's surrounded on the north and east (from where we entered) by - seriously - a very wide moat." %}
...
{% include _figure.html src="/img/dprk-part-4/airport-coffee.jpg" caption="Not a bad place to be laid to rest. It's surrounded on the north and east (from where we entered) by - seriously - a very wide moat." %}
...
{% include _figure.html src="/img/dprk-part-4/airport-plane.jpg" caption="Not a bad place to be laid to rest. It's surrounded on the north and east (from where we entered) by - seriously - a very wide moat." %}
